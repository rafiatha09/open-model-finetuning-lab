"""Show the batch request shape used by the starter serving layer."""
...
def main() -> None:
    with tempfile.TemporaryDirectory(prefix="batching-demo-") as tmpdir:
        ...
        print("Batching demo")
        print(f"Supports batching: {batch['backend']} / count={batch['count']}")
        print(f"First text: {batch['results'][0]['text'] or '<no text generated>'}")
